...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2022 at 12:47 PM
...
--
-- Table structure for table `groupsp`
--
...
--
-- Dumping data for table `groupsp`
--
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`id_khachhang`) REFERENCES `user` (`id`);
COMMIT;
