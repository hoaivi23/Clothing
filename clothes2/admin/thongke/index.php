         ...
         <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
               <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                  <ul class="nav navbar-nav navbar-right">
                    <li hidden><a href="../../loginadmin.php">Đăng xuất</a></li>
                    </li>
                    </ul>
                  </li>
               </ul>
            ...
            <div class="side-menu-container">
               <ul class="nav navbar-nav">
                  ...
                  <li class="panel panel-default" id="dropdown">
                     ...
                     <i class="fa fa-diamond"></i> Quản lý đơn hàng
                     </a>
                  </li>
                  <!--end-->
                  <!--Quản lý thống kê-->
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><label for="thang">Chọn năm</label>
                                                        ...
                                                        <th>
                                                            <input type="submit" value="LỌC" size="40">
                                                        </th>
                                                        </form>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php
                                                        $thang = !empty($_GET['thang']) ? (int)$_GET['thang'] : '';
                                                        $nam = !empty($_GET['nam']) ? (int)$_GET['nam'] : '';
                                                        ...
                                                        $count = mysqli_query($con,"SELECT COUNT(soluong_sanpham) AS total FROM cart_details,cart WHERE cart_details.id_cart=cart.Id AND cart.cart_status=2
                                                                                AND year(cart.ngaytao) like '%$nam%' AND month(cart.ngaytao)like '%$thang%'");
                                                        $row1 = mysqli_fetch_assoc($count);
                                                        $temp = mysqli_query($con,"SELECT SUM(tongtien) AS tong FROM cart where cart_status=2 AND year(cart.ngaytao) like '%$nam%' AND month(cart.ngaytao)like '%$thang%'");
