                     ...
                     <div class="current_price">
                        <span>
                           <?php if ($detail->pricenew > 0) : ?>
                              ...
                              <p style="color:#f24c74; font-size:30px;font-weight:700;"><?= number_format($detail->pricenew) ?>VND</p>
                        ...
                        <select name="size" id="size" style="width: 150px">
                           <?php
                           $dsloaisize = $db->query("SELECT * FROM size");
                           while ($danhsachsize = $dsloaisize->fetch_object()) :
                           ?>
                              <option value="<?php echo $danhsachsize->id ?>"><?php echo $danhsachsize->namesize ?></option>
                           <?php endwhile; ?>
                        </select>
                     </div>
                        ...
                        <div class="product_variants">
                           <div class="quickview_plus_minus">
                              <?php if ($detail->soluong != 0) { ?>
                                 ...
                                 <div class="quickview_plus_minus_inner" style="display: flex; flex-direction: row; justify-content: space-between;">
                                    <input type="hidden" name="id" value="<?= $detail->id; ?>">
                                    <input type="hidden" name="action" value="add">
                                    <input type="number" min="1" name="quantity" value="1">
                                    <input type="submit" value="ADD TO CART" size="40">
                                 <?php } else { ?>
                                    <label style="font-weight:1000; font-size:30px; color:#78a206">Sold Out</label>
                                 <?php } ?>
                                 </div>
                           </div>
                  </form>
                        ...
                        <div class="single_product__inner">
                           ...
                           <div class="product__content text-center">
                              ...
                              <div class="product__hover">
                                 <ul>
                                    <!-- <?php if ($sp->soluong != 0) { ?>
                                    <li><a href="carts/add.php?id=<?php echo $sp->id; ?>"><i class="ion-android-cart"></i></a></li>
                                 <?php } else { ?>
